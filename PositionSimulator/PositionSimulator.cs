...
namespace PositionSimulator;

internal class PositionSimulator
{
    ...
    public async Task<List<IGeoCoordinate>> GetCoordinates(Point vehicleLocation, Point userLocation, Point userDestinationLocation)
    {
    ...
    private async Task<List<IGeoCoordinate>> GetNewCoordinates(string polylineHash)
    {
    ...
    private GeoCoordinate CreateNewCord(GeoCoordinate cord1, GeoCoordinate cord2, double? distance)
    {
        if (distance == null)
            distance = 0.027;
    ...
    private double CalculateDistance(IGeoCoordinate point1, IGeoCoordinate point2)
    {
        double R = 6371.0;
    ...
    private double CalculateBearing(IGeoCoordinate start, IGeoCoordinate end)
    {
    ...
    private (double, double) CalculateDestinationPoint(IGeoCoordinate start, double bearing, double? distance)
    {
